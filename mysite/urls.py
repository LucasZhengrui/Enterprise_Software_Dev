...
urlpatterns = [
    ...
    path('', include('disaster_list.urls')),
    path('list/', include('disaster_list.urls')),
    path('trash/', include('disaster_trash_list.urls')),
    ...
    path('edit/<int:dis_id>/', include('disaster_edit.urls')),
